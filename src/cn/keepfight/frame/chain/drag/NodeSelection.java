...
//    static Label yLabel ;
    ...
    public void createInstance() {
        ...
        DragMouseGestures dragMouseGestures = new DragMouseGestures(selectionManager);
        Pane pane = new Pane();
//        pane.setStyle("-fx-background-color:grey");

        new RubberBandSelection(pane, selectionManager);
        ...
        for( int row=0; row < 4; row++) {
            for( int col=0; col < 4; col++) {
                ...
                MAGA selectable = new MAGA( width, height, images[col]);
